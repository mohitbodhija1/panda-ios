-- Migration: narrow group avatar keys to the 3 curated photos.
-- Keeps rpc_create_group aligned with iOS avatar picker/mapping.
...
begin
    ...
    if avatar_in is not null
       and avatar_in not in ('group_avatar_1', 'group_avatar_2', 'group_avatar_3')
    then
        avatar_in := null;
    end if;
