...
#ifndef PANDASPLIT___BILL_SPLITTER___GROUP_EXPENSE_TRACKER_SWIFT_H
#define PANDASPLIT___BILL_SPLITTER___GROUP_EXPENSE_TRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PandaSplit___Bill_Splitter___Group_Expense_Tracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
